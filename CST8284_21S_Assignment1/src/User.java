...
public class User {
	...
	/**
	 * is a static counter that increments each time a User object is created. The
	 * current value is assigned to the id of the new User object and is then
	 * incremented by 1. If a User is created without age, it defaults to 18. Use
